...
if (isset($_POST["getProizvod"])) {
	...
	$proizvodi_query="SELECT * FROM knjige LIMIT $start,$limit "; 
		...
		while ($row=mysqli_fetch_array($run_query)) {
			...
			?>
				<div class="row">
					...
					<div class="col-md-2"><?php echo "$pro_title"; ?></div> 					
					<div class="col-md-2"><input type="text" class='form-control qty' pid='<?php echo "$pro_id"; ?>' id="qty-<?php echo "$pro_id"; ?>" value='<?php echo "$qty"; ?>' ></div>
					<div class="col-md-2"><input type="text" class='form-control price' pid='<?php echo "$pro_id"; ?>' id='price-<?php echo "$pro_id"; ?>' value='<?php echo "$pro_price"; ?>' disabled></div>
					<div class="col-md-2"><input type="text" class='form-control total' pid='<?php echo "$pro_id"; ?>' id='total-<?php echo "$pro_id"; ?>' value='<?php echo "$total"; ?>' disabled></div>
				</div>
			<?php
			$no=$no+1;
		}
